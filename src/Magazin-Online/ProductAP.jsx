...
const ProductAP = () => {
    const {apples,addToCart3} = useContext (Conte)
    const {a} = useParams()
    const currentProduct = apples.find(obj=> obj.a === a)
  return (
...
<div>
    ...
    <div className='flex items-center flex-col gap-3'>
        ...
        <img className='h-2/4 w-96 object-cover rounded-xl' src={currentProduct.image} alt="" />
            ...
            <h2 className='text-3xl font-semibold'>{currentProduct.a}</h2>
...
<div className='text'>
    ...
    <h2>IN RATE </h2> 
     <h3>{currentProduct.credit}lei/lunar</h3>
            ...
            <Link to="/accesorii"><button className='bg-gray-700 text-white px-3 py-1 flex items-center gap-2 text-lg rounded-md hover:bg-violet-600'>Apple</button></Link>

<br />

<button className='bg-gray-700 text-white px-3 py-1 flex items-center gap-2 text-lg rounded-md hover:bg-violet-600' onClick={() => addToCart3(currentProduct.a)}>Adauga in cos</button>
<br />
