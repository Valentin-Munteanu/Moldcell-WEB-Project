...
const ProductT = () => {
    ...
    const {t} = useParams()
    const currentProduct = tab.find(obj=> obj.t === t)
  return (
...
<div>
    ...
    <div className='flex items-center flex-col gap-3'>
        ...
        <img className='h-2/4 w-96 object-cover rounded-xl' src={currentProduct.image} alt="" />
            ...
            <h2 className='text-3xl font-semibold'>{currentProduct.t}</h2>
...
<div className='text'>
    ...
    <h2>IN RATE </h2> 
     <h3>{currentProduct.credit}lei/lunar</h3>
            ...
            <Link to="/tablete"><button className='bg-gray-700 text-white px-3 py-1 flex items-center gap-2 text-lg rounded-md hover:bg-violet-600'>Tablete</button></Link>

<br />

<button className='bg-gray-700 text-white px-3 py-1 flex items-center gap-2 text-lg rounded-md hover:bg-violet-600' onClick={() => addToCart5(currentProduct.t)}>Adauga in cos</button>
