...
const Product = () => {
    ...
    const {e} = useParams()
    const currentProduct = dats.find(obj=> obj.e === e)
  return (
...
<div>
    ...
    <div className='flex items-center flex-col gap-3'>
        ...
        <img className='h-2/4 w-80 object-cover rounded-xl' src={currentProduct.image} alt="" />
            ...
            <h2 className='text-3xl font-semibold'>{currentProduct.e}</h2>
...
<div className='text'>
    ...
    <h2>IN RATE </h2> 
     <h3>{currentProduct.credit}lei/lunar</h3>
            ...
            <Link to="/Exclusiv"><button className='bg-gray-700 text-white px-3 py-1 flex items-center gap-2 text-lg rounded-md hover:bg-violet-600'>Exclusiv</button></Link>
<button className='bg-gray-700 text-white px-3 py-1 flex items-center gap-2 text-lg rounded-md hover:bg-violet-600' onClick={() => addToCart4(currentProduct.e)}>Adauga in cos</button>
